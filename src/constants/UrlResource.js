...
export  const URL_GET_ALL_TIPOS_GASTOS_DIRECTOS = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/tipo-gd/all";
export  const URL_SAVE_TIPOS_GASTOS_DIRECTOS = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/tipo-gd/save";
export  const URL_DELETE_TIPOS_GASTOS_DIRECTOS = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/tipo-gd/delete/id/";
export  const URL_EDIT_TIPOS_GASTOS_DIRECTOS = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/tipo-gd/update";

//Elementos gasto
export  const URL_GET_ALL_ELEMENTOS_GASTO = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/elemento-gasto/all";
export  const URL_SAVE_ELEMENTOS_GASTO = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/elemento-gasto/save";
export  const URL_DELETE_ELEMENTOS_GASTO = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/elemento-gasto/delete/id/";
export  const URL_UPDATE_ELEMENTOS_GASTO = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/elemento-gasto/update";

//Subelemento gasto
export  const URL_GET_ALL_SUBELEMENTOS_GASTO = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/subelemento-gasto/all";
export  const URL_SAVE_SUBELEMENTOS_GASTO = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/subelemento-gasto/save";
export  const URL_DELETE_SUBELEMENTOS_GASTO = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/subelemento-gasto/delete/id/";
export  const URL_UPDATE_SUBELEMENTOS_GASTO = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/subelemento-gasto/update";

//Gastos directos
export  const URL_GET_ALL_GASTO_DIRECTO = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/gasto-directo/all";
export  const URL_SAVE_GASTO_DIRECTO = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/gasto-directo/save";
export  const URL_DELETE_GASTO_DIRECTO = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/gasto-directo/delete/id/";
export  const URL_UPDATE_GASTO_DIRECTO = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/gasto-directo/update";

//Tipo gastos indirectos
export  const URL_GET_ALL_TIPOS_GASTOS_INDIRECTOS = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/tipo-gi/all";
export  const URL_SAVE_TIPOS_GASTOS_INDIRECTOS = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/tipo-gi/save";
export  const URL_DELETE_TIPOS_GASTOS_INDIRECTOS = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/tipo-gi/delete/id/";
export  const URL_EDIT_TIPOS_GASTOS_INDIRECTOS = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/tipo-gi/update";

//Gastos indirectos
export  const URL_GET_ALL_GASTO_INDIRECTO = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/gasto-indirecto/all";
export  const URL_SAVE_GASTO_INDIRECTO = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/gasto-indirecto/save";
export  const URL_DELETE_GASTO_INDIRECTO = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/gasto-indirecto/delete/id/";
export  const URL_UPDATE_GASTO_INDIRECTO = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/gasto-indirecto/update";

//Cargos
export  const URL_GET_ALL_CARGOS = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/cargo/all";
export  const URL_SAVE_CARGOS = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/cargo/save";
export  const URL_DELETE_CARGOS = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/cargo/delete/id/";
export  const URL_UPDATE_CARGOS = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/cargo/update";

//Etapas
export  const URL_GET_ALL_ETAPAS = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/etapa/all";
export  const URL_SAVE_ETAPAS = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/etapa/save";
export  const URL_DELETE_ETAPAS = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/etapa/delete/id/";
export  const URL_UPDATE_ETAPAS = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/etapa/update";

//Cliente
export  const URL_GET_ALL_CLIENTE = SERVER_HOST+"/rodas-costos/api/v1/rodas-costos/cliente/all";
